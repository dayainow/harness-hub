...
export declare class HarnessesController {
    private readonly harnessesService;
    constructor(harnessesService: HarnessesService);
    ...
    findBySlug(org: string, name: string): Promise<{
        benchmarks: {
            name: string;
            score: number;
            model: string;
